 ...
 * @{
 *
 * \defgroup felicia-platforms Felicia platforms
 *
 * \file
 *  Configuration for the felicia-based platforms
 */
...
/* Run-time dual-mode configuration */
#ifndef FELICIA_PLATFORM_WITH_DUAL_MODE
#define FELICIA_PLATFORM_WITH_DUAL_MODE      0
